...
import { FiArrowRight, FiDollarSign, FiShield, FiClock, FiSmartphone } from "react-icons/fi";
 ...
 const axiosPublic = useAxiosPublic();
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:mt-16 lg:px-8 xl:mt-20">
              <div className="sm:text-center lg:text-left">
                ...
                >
                  ...
                  <span className="block text-indigo-600">Send & Receive Money</span>
                </motion.h1>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  Fast, secure payments for individuals and businesses. Join millions who trust our platform for their financial transactions.
                </motion.p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  >
                    {
                      user ? 
                        type === "admin" ? <Link to={"/dashboard/admin"}><button
                        className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
                      >
                        Go to Dashboard <FiArrowRight className="ml-2" />
                      </button></Link> :  <Link to={"/dashboard/user"}><button
                        className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
                      >
                        Go to Dashboard <FiArrowRight className="ml-2" />
                      </button></Link>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
      {[
        { name: "Transactions", value: stats.totalTransactions, suffix: "M+" },
        ...
        >
          ...
          <p className="mt-2 text-lg font-medium text-indigo-100">{stat.name}</p>
        </motion.div>
      ))}
    </div>
  </div>
              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Connect your bank account, card, or other payment methods"
                  },
                  {
                    step: "3",
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          ...
          >
            <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              ...
              <span className="block text-indigo-600">Sign up today and get your first 5 transactions free.</span>
            </h2>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
          ...
          >
            <div className="inline-flex rounded-md shadow">
              ...
              >
                {user ? "Go to Dashboard" : "Get Started"} <FiArrowRight className="ml-2" />
              </button>
            </div>
          </motion.div>
        </div>
